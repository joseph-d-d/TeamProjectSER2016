...
public class Ghost extends GameObject {
	...
	protected Ghost(int x, int y, Color color, Input input, Board gameBoard, Boolean isActive, Behavior behavior) {
	...
	private void randomMovePattern() {
		...
		if ((totalPacmanMoves > 0) && (totalGhostMoves < totalPacmanMoves) && (totalGhostMoves < 2)) {
			left = true;
		} else if ((totalPacmanMoves > 2) && (totalGhostMoves < totalPacmanMoves) && (totalGhostMoves < 4)) {
			up = true;
		}
